                ...
                children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: const Icon(Icons.notifications_none_rounded, color: Color(0xFF2C3E50)),
                          ),
                        ),
                      ],
                    ),
                          ...
                          child: Obx(() {
                             ...
                             return GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  color: isSelected ? Colors.teal : Colors.white.withOpacity(0.6),
                                  borderRadius: BorderRadius.circular(20),
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Featured", style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: const Color(0xFF2C3E50))),
                        GestureDetector(
                                     ...
                                     children: [
                                       ...
                                       Row(
                                         children: [
                                           ...
                                           Text("${item.rating}", style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.bold, color: const Color(0xFF2C3E50))),
                                         ],
                                       ),
                                     ],
                                   ),
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24),
                    child: Text("Nearby Places", style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: const Color(0xFF2C3E50))),
                  ),
                               ...
                               child: Row(
                                 children: [
                                    Container(
                                     ...
                                     child: Center(child: Icon(Icons.home_work_rounded, color: Colors.grey[400])),
                                   ),
                                   ...
                                   Expanded(
                                     child: Column(
                                       crossAxisAlignment: CrossAxisAlignment.start,
                                       children: [
                                         Text(item.name, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFF2C3E50))),
                                          const SizedBox(height: 4),
               ...
               child: GlassContainer(
                 ...
                 child: Row(
                   ...
                   children: [
                     ...
                     _buildBottomNavItem(Icons.favorite_border_rounded, "Saved", false),
                     _buildBottomNavItem(Icons.article_outlined, "Bookings", false),
